...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает заблокированный урон персонажем."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает спец-умение персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Вывод инфы о выбранном класе, начало тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Вывод инфы о персонаже, подтверждение выбора класса."""
    approve_choice: str = ''
    char_class: str = ''
...
def main():
    """Приветствие, выбор имени, выбор класса."""
